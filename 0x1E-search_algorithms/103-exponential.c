...
/**
 * binary_search - finds value in a sorted array of integers using the binary search algorithm
 * @array: array of integers provided
 * @left: Left element(s)
 * @right: Right element(s)
 * @value: value to search for in sorted array
