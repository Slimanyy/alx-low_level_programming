...
/**
  * advanced_binary_recursive - Searches recursively in an array of integers using binary search.
  * @array: A pointer to the first element of the sub-array to search.
  * @left: The starting index of the sub-array to search.
  * @right: The ending index of the subarray to search.
  * @value: The value to search for.
  * Return: If the value is not present, -1 or the index where the value is located.
  * Description: print the sub-array being searched after each query.
  */
